...
import { ShieldAlert, ArrowRight, Inbox, Flag, FileSearch, ArrowLeft } from "lucide-react";

export const Route = createFileRoute("/_authenticated/training/$slug/start")({
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-3">
        <Stat icon={Inbox} title="Inbox tasks" body="Mix of legitimate and suspicious emails." />
